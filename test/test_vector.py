...
class TestVectorBus(unittest.TestCase):
    def setUp(self) -> None:
        ...
        can.interfaces.vector.canlib.xldriver.xlCanSetChannelParams = Mock(
            return_value=0
        )
    ...
    def test_bus_creation_bittiming_class(self) -> None:
        ...
        xlCanSetChannelParams_args = can.interfaces.vector.canlib.xldriver.xlCanSetChannelParams.call_args[
            0
        ]
        chipParams = xlCanSetChannelParams_args[2]
        self.assertEqual(chipParams.bitRate, 250000)
        self.assertEqual(chipParams.tseg1, 13)
        self.assertEqual(chipParams.tseg2, 2)
        self.assertEqual(chipParams.sam, 1)

    def test_bus_creation_bittiming_class_fd(self) -> None:
        timing = can.BitTiming(
            f_clock=8000000, bitrate=250000, tseg1=13, tseg2=2, sjw=1
        )
        data_timing = can.BitTiming(
        ...
        self.assertEqual(canFdConf.sjwDbr, 10)
