...
if __name__ == "__main__":
    print "xml2tdv.py is deprecated."
    print "It will not work with the pickled log files generated by newer",
    print "versions of pycanlib - use dat2tdv.py for newer log files instead."
